...
namespace PTSL.GENERIC.Api.Controllers.SocialForestry.Reforestation
{
    ...
    [ApiController]
    public class ReplantationCostInfoController : BaseController<IReplantationCostInfoService, ReplantationCostInfoVM, ReplantationCostInfo>
    {
        public ReplantationCostInfoController(IReplantationCostInfoService service) :
            base(service)
        {
        }
    }
