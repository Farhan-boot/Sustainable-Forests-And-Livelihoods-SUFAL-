...
namespace PTSL.GENERIC.Api.Controllers.PatrollingSchedulingInformetion
{
    ...
    [ApiController]
    public class PatrollingSchedulingMemberController : BaseController<IPatrollingSchedulingMemberService, PatrollingSchedulingMemberVM, PatrollingSchedulingMember>
    {
        public PatrollingSchedulingMemberController(IPatrollingSchedulingMemberService service) :
            base(service)
        { }
    }
}
