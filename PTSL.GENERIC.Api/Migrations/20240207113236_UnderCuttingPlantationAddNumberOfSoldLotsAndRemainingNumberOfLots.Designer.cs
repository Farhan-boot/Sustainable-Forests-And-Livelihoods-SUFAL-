...
namespace PTSL.GENERIC.Api.Migrations
{
    ...
    [Migration("20240207113236_UnderCuttingPlantationAddNumberOfSoldLotsAndRemainingNumberOfLots")]
    partial class UnderCuttingPlantationAddNumberOfSoldLotsAndRemainingNumberOfLots
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.AccountManagement.AccountDeposit", b =>
                {
                    ...
                    b.Property<int>("AccountDepositApprovalProcess")
                        .HasColumnType("integer");

                    b.Property<int>("AccountDepositStatus")
                        .HasColumnType("integer");
                    ...
                    b.Property<long?>("NextApprovalOrderNo")
                        .HasColumnType("bigint");

                    b.Property<long?>("NextApprovalUserId")
                        .HasColumnType("bigint");

                    b.Property<long?>("NextApprovalUserRoleId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("NextApprovalUserId");

                    b.HasIndex("NextApprovalUserRoleId");
            ...
            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.AccountManagement.AccountDepositApproval", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long?>("ApprovedByRoleId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("ForwardedById")
                        .HasColumnType("bigint");

                    b.Property<long?>("ForwardedByRoleId")
                        .HasColumnType("bigint");

                    b.Property<long?>("ForwardedToId")
                        .HasColumnType("bigint");

                    b.Property<long?>("ForwardedToRoleId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ForwardedByRoleId");

                    b.HasIndex("ForwardedToId");

                    b.HasIndex("ForwardedToRoleId");

                    b.HasIndex("RowId");

                    b.ToTable("AccountDepositApproval");
                });
            ...
            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.AccountManagement.AccountTransfer", b =>
                {
                    ...
                    b.Property<int>("AccountTransferApprovalProcess")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.AccountManagement.AccountTransferApproval", b =>
                {
                    ...
                    b.ToTable("AccountTransferApprovals", "AccountManagement");
                });
            ...
            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.Beneficiary.Cip", b =>
                {
                    ...
                    b.Property<long?>("TypeOfHouseNewId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.Beneficiary.TypeOfHouse", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.SocialForestry.Cutting.CuttingPlantation", b =>
                {
                    ...
                    b.Property<int?>("NumberOfSoldLots")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("RemainingNumberOfLots")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.SocialForestry.Cutting.DistributionFundType", b =>
                {
                    ...
                    b.Property<int>("DistributionFundTypeEnum")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.SocialForestry.Nursery.NurseryDamageInformation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("NurseryDamageInformation");
                });
            ...
            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.AccountManagement.AccountDeposit", b =>
                {
                    ...
                    b.HasOne("PTSL.GENERIC.Common.Entity.User", "NextApprovalUser")
                        .WithMany()
                        .HasForeignKey("NextApprovalUserId");

                    b.HasOne("PTSL.GENERIC.Common.Entity.UserRole", "NextApprovalUserRole")
                        .WithMany()
                        .HasForeignKey("NextApprovalUserRoleId");
                    ...
                    b.Navigation("NextApprovalUser");

                    b.Navigation("NextApprovalUserRole");
            ...
            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.AccountManagement.AccountDepositApproval", b =>
                {
                    b.HasOne("PTSL.GENERIC.Common.Entity.User", "ApprovedBy")
                        .WithMany()
                        .HasForeignKey("ApprovedById");

                    b.HasOne("PTSL.GENERIC.Common.Entity.UserRole", "ApprovedByRole")
                        .WithMany()
                        .HasForeignKey("ApprovedByRoleId");

                    b.HasOne("PTSL.GENERIC.Common.Entity.User", "ForwardedBy")
                        .WithMany()
                        .HasForeignKey("ForwardedById");

                    b.HasOne("PTSL.GENERIC.Common.Entity.UserRole", "ForwardedByRole")
                        .WithMany()
                        .HasForeignKey("ForwardedByRoleId");

                    b.HasOne("PTSL.GENERIC.Common.Entity.User", "ForwardedTo")
                        .WithMany()
                        .HasForeignKey("ForwardedToId");

                    b.HasOne("PTSL.GENERIC.Common.Entity.UserRole", "ForwardedToRole")
                        .WithMany()
                        .HasForeignKey("ForwardedToRoleId");

                    b.HasOne("PTSL.GENERIC.Common.Entity.AccountManagement.AccountDeposit", "Row")
                        .WithMany("AccountDepositApprovals")
                        .HasForeignKey("RowId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ForwardedByRole");

                    b.Navigation("ForwardedTo");

                    b.Navigation("ForwardedToRole");
            ...
            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.Beneficiary.Cip", b =>
                {
                    ...
                    b.HasOne("PTSL.GENERIC.Common.Entity.Beneficiary.TypeOfHouse", "TypeOfHouseNew")
                        .WithMany("Cips")
                        .HasForeignKey("TypeOfHouseNewId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.Beneficiary.Survey", b =>
                {
                    ...
                    b.HasOne("PTSL.GENERIC.Common.Entity.Beneficiary.TypeOfHouse", "TypeOfHouse")
                        .WithMany("Surveys")
                        .HasForeignKey("TypeOfHouseId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.SocialForestry.Nursery.NurseryDamageInformation", b =>
                {
                    b.HasOne("PTSL.GENERIC.Common.Entity.SocialForestry.Nursery.NurseryInformation", "NurseryInformation")
                        .WithMany("NurseryDamageInformations")
                        .HasForeignKey("NurseryInformationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.AccountManagement.AccountDeposit", b =>
                {
                    b.Navigation("AccountDepositApprovals");
                });
            ...
            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.SocialForestry.Nursery.NurseryInformation", b =>
                {
                    ...
                    b.Navigation("NurseryDamageInformations");
