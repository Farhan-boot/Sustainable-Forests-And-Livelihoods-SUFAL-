...
namespace PTSL.GENERIC.Api.Migrations
{
    ...
    [Migration("20221220092728_Update-FcvCxecutiveCommitteeMember")]
    partial class UpdateFcvCxecutiveCommitteeMember
    {
            ...
            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.ForestManagement.ExecutiveCommittee", b =>
                {
                    ...
                    b.Property<long?>("FcvCxecutiveCommitteeMemberId")
                        .HasColumnType("bigint");

                    b.Property<long?>("FcvCxecutiveCommitteeMembersId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("FcvCxecutiveCommitteeMemberId");

                    b.HasIndex("FcvCxecutiveCommitteeMembersId");

                    b.ToTable("ExecutiveCommittee","BEN");
                });

            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.ForestManagement.FcvCxecutiveCommitteeMember", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.ForestManagement.ExecutiveCommittee", b =>
                {
                    b.HasOne("PTSL.GENERIC.Common.Entity.Beneficiary.Ngo", "Ngos")
                        ...
                        .HasForeignKey("FcvCxecutiveCommitteeMemberId");

                    b.HasOne("PTSL.GENERIC.Common.Entity.ForestManagement.FcvCxecutiveCommitteeMember", "FcvCxecutiveCommitteeMembers")
                        .WithMany()
                        .HasForeignKey("FcvCxecutiveCommitteeMembersId");
                });

            modelBuilder.Entity("PTSL.GENERIC.Common.Entity.ForestManagement.FcvCxecutiveCommitteeMember", b =>
                {
                    b.HasOne("PTSL.GENERIC.Common.Entity.Beneficiary.Ngo", "Ngos")
                        .WithMany("FcvCxecutiveCommitteeMembers")
                        .HasForeignKey("NgoId");
                });
