...
{
    public interface IReplantationSocialForestryBeneficiaryMapService : IBaseService<ReplantationSocialForestryBeneficiaryMapVM, ReplantationSocialForestryBeneficiaryMap>
    {
    }
}