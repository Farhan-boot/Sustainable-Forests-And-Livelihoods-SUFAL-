...
{
    public interface ISocialForestryTrainingParticipentsMapService : IBaseService<SocialForestryTrainingParticipentsMapVM, SocialForestryTrainingParticipentsMap>
    {
    }
}