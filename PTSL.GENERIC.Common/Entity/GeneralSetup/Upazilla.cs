...
namespace PTSL.GENERIC.Common.Entity.GeneralSetup
{
    public class Upazilla : BaseEntity
    {
        ...
        public List<Survey>? SurveyPresentUpazillas { get; set; }
        public List<Survey>? SurveyPermanentUpazillas { get; set; }
        ...
        //public List<NewRaisedPlantationUpazillaMap>? NewRaisedPlantationUpazillaMaps { get; set; }
