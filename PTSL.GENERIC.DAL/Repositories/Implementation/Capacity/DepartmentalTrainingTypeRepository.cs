...
{
    public class DepartmentalTrainingTypeRepository : BaseRepository<DepartmentalTrainingType>, IDepartmentalTrainingTypeRepository
    {
        public DepartmentalTrainingTypeRepository(
